 ...
 */
package com.quansu.viewpagerindicator;
...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //If we want the widget_line on the top change height to zero and invert the widget_line height to trick the drawing code
