...
import com.quansu.widget.irecyclerview.RefreshTrigger;
...
public class ClassicRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public void onMove(boolean isComplete, boolean automatic, int moved) {
        if (!isComplete) {
            ...
            if (moved <= mHeight) {
                ...
                tvRefresh.setText(getContext().getString(R.string.slide_to_refresh));
            } else {
                tvRefresh.setText(getContext().getString(R.string.loosen_the_refresh));
                if (!rotated) {
                    ivArrow.clearAnimation();
    ...
    public void onComplete() {
        ...
        ivArrow.setVisibility(GONE);
        progressBar.setVisibility(GONE);
        tvRefresh.setText(getContext().getString(R.string.refresh_to_complete));
    }
