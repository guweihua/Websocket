package com.quansu.widget.irecyclerview;
...
public class IRecyclerView extends RecyclerView {
    ...
    public IRecyclerView(Context context, @Nullable AttributeSet attrs) {
        ...
        // mGestureDetector = new GestureDetector(new YScrollDetector());//new add
    ...
    public BaseAdapterInter getIAdapter() {
        Adapter adapter = ((WrapperAdapter) getAdapter()).getAdapter();
        BaseAdapterInter baseAdapterInter = null;
        if (adapter instanceof BaseAdapterInter) {
            baseAdapterInter = (BaseAdapterInter) adapter;
        }
//        else if (adapter instanceof AnimationAdapter) {
//            baseAdapterInter = (BaseAdapterInter) ((AnimationAdapter) adapter).getWrappedAdapter();
//        }

        return baseAdapterInter;
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        switch (action) {
          ...
          // return super.onInterceptTouchEvent(e) && mGestureDetector.onTouchEvent(e);//new add
  ...
  // private GestureDetector mGestureDetector;//new add


//    class YScrollDetector extends GestureDetector.SimpleOnGestureListener {//new add
//          @Override
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (index < 0) {
                    Log.e(TAG, "Error processing scroll; pointer index for id " + index + " not found. Did any MotionEvents netInstance skipped?");
                    return false;
                }
