 ...
 */
package com.quansu.widget.sidebar;
...
import com.quansu.widget.sidebar.sections.EasyImageSection;
import com.quansu.widget.sidebar.sections.EasySection;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.sections.size() > 0) {
            ...
            float top = viewHeight / 2 - allSectionHeight / 2 + this.sectionHeight / 2 -
                    this.sectionFontSize / 2 + dp2px(10);
