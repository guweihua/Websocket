...
//        nBuilder.setPriority(NotificationCompat.PRIORITY_MAX);
    ...
    public void notify_mailbox(PendingIntent pendingIntent, int smallIcon, int largeIcon, ArrayList<String> messageList,
        ...
        inboxStyle.setSummaryText(mContext.getString(R.string.in_left_parenthesis) + messageList.size() + mContext.getString(R.string.item)+mContext.getString(R.string.in_right_parenthesis) + title);
    ...
    public void notify_normail_moreline(PendingIntent pendingIntent, int smallIcon, String ticker,
        ...
        if (sdk < Build.VERSION_CODES.JELLY_BEAN) {
            ...
            Toast.makeText(mContext, mContext.getString(R.string.phone_below_four), Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void notify_progress(PendingIntent pendingIntent, int smallIcon,
                                String ticker, String title, String content, boolean sound, boolean vibrate, boolean lights, int progress, Service service) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (progress >= 100) {
                    ...
                    cBuilder.setContentText(mContext.getString(R.string.download_complete)).
    ...
    public void notify_HeadUp(PendingIntent pendingIntent, int smallIcon, int largeIcon,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            Toast.makeText(mContext, mContext.getString(R.string.phone_below_five), Toast.LENGTH_SHORT).show();
        }
        sent();
    }
     ...
     * 发送通知
     */
    private void sentForground(Service service) {
        notification = cBuilder.build();
        //发送该通知
