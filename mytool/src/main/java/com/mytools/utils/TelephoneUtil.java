...
//        PermissionUtils.checkPer(context, () -> {
//            TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String printTelephoneInfo(Context context) {
        ...
        if (IMSI != null) {
            if (IMSI.startsWith("46000") || IMSI.startsWith("46002")) {
                providerName = context.getString(R.string.china_mobile);
            } else if (IMSI.startsWith("46001")) {
                providerName = context.getString(R.string.china_unicom);
            } else if (IMSI.startsWith("46003")) {
                providerName = context.getString(R.string.china_telecom);
            }
        }
        sb.append(providerName).append(context.getString(R.string.cell_phone_number)+context.getString(R.string.colon)).append(tm.getLine1Number()).append(context.getString(R.string.imsi)+context.getString(R.string.colon)).append(IMSI);
