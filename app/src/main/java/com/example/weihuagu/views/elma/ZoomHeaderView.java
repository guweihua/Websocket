...
public class ZoomHeaderView extends LinearLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mFirstY = getY();
        mCloseTxt = findViewById(R.id.tv_close);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e("Asfakf", "moveY:" + moveY + "    currentY:" + currentY);


                //向上滑动viewpager整体移动
                if (currentY + moveY < 0 && currentY + moveY > -getHeight() / 2) {

                    Log.e("Asfakf", "doPagerUp");
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.e("Asfakf", "upY:" + upY + "    currentUpY:" + currentUpY);
                ...
                if (upY + currentUpY < -getHeight() / 4) {
                    if (upY + currentUpY < mMaxY) {
                        ...
                        Log.e("Asfakf", "expand(mMaxY)");
                        expand(mMaxY);
                    } else {
                        Log.e("Asfakf", "expand(upY + currentUpY)");
