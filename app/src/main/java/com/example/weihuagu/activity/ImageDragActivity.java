...
import com.example.weihuagu.utils.drawphoto.DragPhotoView;
import com.example.weihuagu.websocket.R;

import java.util.ArrayList;
import java.util.List;

public class ImageDragActivity extends AppCompatActivity implements DragPhotoView.OnExitListener, DragPhotoView.OnTapListener {
    ...
    private void initView() {
        ...
        for (int i = 0; i < mPhotoViews.length; i++) {
            ...
            Glide.with(this)
                ...
                mPhotoViews[i].setImageResource(R.drawable.bg_splash_2);
